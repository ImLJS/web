...
const ProjectCardBento = ({
	...
	return (
		<BentoLayout height="h-[250px] md:h-[275px] lg:h-[220px]" linkTo={linkTo}>
			<div className="group flex h-full">
				<div className="flex flex-col justify-between pr-3 text-left">
				...
				<div className="relative ml-auto">
					...
					<img
						className="absolute top-0 left-0 h-[270px] w-[180px] rotate-[8deg] rounded-lg object-cover shadow transition-all duration-500 group-hover:rotate-[4deg] group-hover:scale-105"
						src={imageUrl}
						alt={`${title} preview`}
					/>
				</div>
