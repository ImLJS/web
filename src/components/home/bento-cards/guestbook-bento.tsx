...
const GuestbookBento = () => {
	return (
		<motion.div initial="initial" whileHover="hover">
			<BentoLayout linkTo="#" height="h-[276px]">
				{/* Dots */}
				<div className="absolute top-0 h-full w-full bg-[radial-gradient(#e5e7eb_1px,transparent_2px)] [background-size:16px_16px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)]" />
				...
				{/* Card 2 */}
				<motion.svg
					className="-right-5 absolute top-8 w-56 md:top-0 md:right-0"
					viewBox="0 0 214 223"
					fill="none"
					xmlns="http://www.w3.org/2000/svg"
				...
				<div className="grid h-full grid-cols-2 grid-rows-2 items-end gap-8">
					<div className="z-10 col-1 row-start-2">
						<h2 className="mb-2 font-medium">Guestbook</h2>
